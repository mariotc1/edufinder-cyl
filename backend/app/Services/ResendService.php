<?php
    ...
    // SERVICIO DE CORREO VIA API (RESEND)
    // Alternativa para envío de correos usando la API de Resend
    class ResendService {
        protected $apiKey;
        protected $fromEmail;
        ...
        // Realiza una petición POST a la API de Resend
        ...
        // PLANTILLA BASE HTML
        // Estilos y estructura común para todos los correos
