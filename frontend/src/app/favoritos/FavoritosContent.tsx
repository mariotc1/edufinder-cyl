    ...
    return (
        <div className="min-h-screen bg-brand-gradient pt-6 md:pt-20 pb-12 px-4 sm:px-6">
             <div className="max-w-7xl mx-auto">
                <button
                    onClick={() => router.back()}
                    className="hidden md:inline-flex items-center gap-2 text-neutral-500 hover:text-[#223945] mb-8 font-bold transition-colors text-sm uppercase tracking-wide group"
                >
