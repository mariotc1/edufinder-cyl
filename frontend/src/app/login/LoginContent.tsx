...
import { LogIn, Mail, Lock, Eye, EyeOff, ChevronLeft, Loader2 } from 'lucide-react';
                ...
                <div className="relative bg-white/90 backdrop-blur-xl rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/50 overflow-hidden p-5 md:p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className={`w-full bg-[#223945] text-white px-8 py-3 rounded-xl font-bold shadow-lg shadow-[#223945]/20 hover:shadow-[#223945]/40 hover:-translate-y-0.5 transition-all text-sm uppercase tracking-wide flex items-center justify-center gap-2 group ${isLoading ? 'opacity-80 cursor-not-allowed transform-none hover:transform-none' : ''}`}
                        >
                            {isLoading ? (
                                <>
